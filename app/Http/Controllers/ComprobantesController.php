...
EOT;
    ...
    {
        $comprobante= Comprobantes::create(['pago_parcial'=>$request->pago,'fecha_pago'=>$request->fechaPago,'pago_servicio_id'=>$request->pagoServicioId,'banco_id'=>$request->banco,'num_recibo'=>$request->recibo]);
