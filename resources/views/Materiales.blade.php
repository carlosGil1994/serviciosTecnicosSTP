    ...
    @component('componentes.paneladdnew')
        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control col-5" placeholder="Nombre" required>
            </div>  
            <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <input type="text" id="precio" name="precio" class="form-control col-5" placeholder="Precio" required>
            </div> 
    ...
    <script>
        function showTable(){
                $('#table').DataTable({
                    ...
                    ,
                    ajax: "{{ url('Materiales/materialesTable')}}",
                    type: 'GET',
                    columns: [
                       ...
                       if($(this).hasClass('completar')){
                         ...
                         if($(this).hasClass('editar')){
                            ...
                            $.ajax({
                                ...
                                $('#frm_add_new').attr('action',"{{url('Materiales/edit')}}/"+$id);
                                $('#descripcion').val(data.Material.descripcion);
                                $('#nombre').val(data.Material.nombre);
                                $('#precio').val(data.Material.precio);
