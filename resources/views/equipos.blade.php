    ...
    @component('componentes.paneladdnew')
        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <input type="text" id="modelo" name="modelo" class="form-control col-5" placeholder="Modelo" required>
            </div> 
            <div class="form-group">
                       ...
                       if($(this).hasClass('completar')){
                         ...
                         if($(this).hasClass('editar')){
                            ...
                            $.ajax({
                                ...
                                $('#frm_add_new').attr('action',"{{url('Equipos/edit')}}/"+$id);
                                $('#descripcion').val(data.equipo.descripcion);
                                $('#modelo').val(data.equipo.modelo);
                                $('#precio').val(data.equipo.precio);
